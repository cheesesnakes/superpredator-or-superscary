...
for (i in unique(data_comp$outcome)) {
  ...
  png(here::here(paste("meta-analysis/output/funnel_sym_", i, ".png", sep = "")), width = 800, height = 800)

  funnel(mod,
    refline = 0, digits = 3, xlab = "Standardized mean difference",
  ...
  funnel_sym <- rbind(funnel_sym, data.frame(
    outcome = i,
